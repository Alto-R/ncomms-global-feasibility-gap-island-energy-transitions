...
# 设置左侧图的样式
# ax1.set_xlabel('Cost Recovery Price Change (USD/kWh)')
...
plt.savefig('climate_stress_cost_analysis.png', dpi=300, bbox_inches='tight')  # 高分辨率保存，自动裁剪空白
...
plt.savefig('climate_stress_cost_reduction_legend.png', dpi=300, bbox_inches='tight')  # 更新文件名
