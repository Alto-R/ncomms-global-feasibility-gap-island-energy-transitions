...
combined_data_2020_1 = xr.open_dataset('sampledata/wind_2020_uas.nc')
combined_data_2020_2 = xr.open_dataset('sampledata/wind_2020_vas.nc')
...
wave_h = xr.open_dataset('sampledata/waveheight_2020.nc')
...
# 设备失效状态聚类
 # --- 参数设置 ---
num_scenarios_to_generate = 10 # 生成10个原始场景用于分析
...
cost_df.to_csv(f'output_sample/{island_lat}_{island_lon}_best_cost_2020.csv', index=False)
capacity_df.to_csv(f'output_sample/{island_lat}_{island_lon}_capacity_2020.csv', index=False)
results.to_csv(f'output_sample/{island_lat}_{island_lon}_results_2020.csv', index=False)