...
for _d in ('pdf', 'svg', 'png'):
    (SCRIPT_DIR / _d).mkdir(exist_ok=True)
...
plt.savefig(SCRIPT_DIR / 'png' / 'climate_stress_cost_analysis.png', dpi=300, bbox_inches='tight')  # 高分辨率保存，自动裁剪空白
plt.savefig(SCRIPT_DIR / 'pdf' / 'climate_stress_cost_analysis.pdf', bbox_inches='tight')
plt.savefig(SCRIPT_DIR / 'svg' / 'climate_stress_cost_analysis.svg', bbox_inches='tight')  # 矢量 PDF 版本
...
plt.savefig(SCRIPT_DIR / 'png' / 'climate_stress_cost_reduction_legend.png', dpi=300, bbox_inches='tight')  # 更新文件名
plt.savefig(SCRIPT_DIR / 'pdf' / 'climate_stress_cost_reduction_legend.pdf', bbox_inches='tight')
plt.savefig(SCRIPT_DIR / 'svg' / 'climate_stress_cost_reduction_legend.svg', bbox_inches='tight')  # 矢量 PDF 版本
